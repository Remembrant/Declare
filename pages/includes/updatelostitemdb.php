...
session_start();
    ...
    //  echo "<script>alert('You Have Updated successfull An Item!!!');window.location='../viewUserlostItems.php'</script>";
     exit();
    }
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <div class="form-group">
                            <label>Status</label>
                            <input type="text" name="status" readonly class="form-control" value="<?php if($row["status"]==0)echo "Pending"; elseif($row["status"]==1) echo "Approved"; elseif($row["status"]==2) echo "Declined"; ?>" maxlength="100" required="">
                        </div>
                        <div class="form-group">
                        ...
                        <a href="../viewUserlostItems.php" class="btn btn-default">Cancel</a>
                    </form>
                </div>
            </div>  
        </div>
