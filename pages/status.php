...
<?php
 ...
 if(isset($_GET['itemId'])){
    ...
    $sql = mysqli_query($conn,"UPDATE items SET read_mesg = 1 WHERE itemId='$id_main1'");
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Pending Items</a>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <?php
                    include_once 'includes/connection.php';
                    $result = mysqli_query($conn,"SELECT * FROM items WHERE status = 0");
                    ?>
                  ...
                  <table class="table">
                   ...
                   <th>
                    ...
                    <tr>
                        ...
                        <td><a href="includes/approve.php?itemId=<?php echo $row["itemId"]; ?>" title='Update Record'><button class =  "btn btn-success">Approve</button></a></td>
                        <td><a href="includes/decline.php?itemId=<?php echo $row["itemId"]; ?>" title='Update Record'><button class =  "btn btn-danger">Decline</button></a></td>
